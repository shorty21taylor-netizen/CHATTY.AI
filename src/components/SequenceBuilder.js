          ...
          return (
            <div
              ...
              style={{
                ...
                padding: '14px 16px',
                borderRadius: 12,
                background: step.on ? 'var(--dark-surface-2)' : 'transparent',
            ...
            >
              ...
              <button
                ...
                style={{
                  ...
                  height: 38,
                  borderRadius: 10,
                  background: isVoice ? 'rgba(212,255,79,0.12)' : 'rgba(52,211,153,0.1)',
                  border: '1px solid ' + (isVoice ? 'rgba(212,255,79,0.3)' : 'rgba(52,211,153,0.3)'),
                  color: isVoice ? '#d4ff4f' : 'var(--emerald-bright)',
                  display: 'flex',
                  alignItems: 'center',
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                <button
                  ...
                  style={{
                    ...
                    height: 22,
                    borderRadius: 999,
                    background: step.on ? 'var(--emerald-bright)' : 'var(--dark-surface-3)',
                    border: '1px solid ' + (step.on ? 'var(--emerald-bright)' : 'var(--dark-border)'),
                    position: 'relative',
                    cursor: 'pointer',
                    padding: 0,
                  }}
                >
                  <span
                    style={{
                      ...
                      height: 16,
                      borderRadius: '50%',
                      background: step.on ? '#06140e' : '#8a9290',
                      transition: 'left .15s',
                    }}
                  />
                </button>
